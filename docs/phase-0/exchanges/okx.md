...
- **Полная global HTML-страница:** при исследовании PHASE 0 web open ограничился ошибкой размера >4 MB; global claims проверены официальными индексированными фрагментами. Региональные страницы и help/best-practice страницы прочитаны непосредственно. Перед реализацией OKX в PHASE 7 нужен повторный просмотр точной региональной schema.
